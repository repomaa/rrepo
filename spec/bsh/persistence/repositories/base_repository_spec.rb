require 'spec_helper'
require 'bsh/persistence/repositories/base_repository'
    ...
    module Repositories
      describe BaseRepository do
        it 'cannot be instanciated' do
          expect { BaseRepository.new(:adapter) }.to raise_error(AbstractError)
        end

        before(:each) do
          stub_const('BSH::Persistence::Models::Test', Class.new)
        end
        ...
        before(:each) do
          stub_const('BSH::Persistence::Models::Test', model_class)
        end
